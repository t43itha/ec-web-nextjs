...
export default function KnightsbridgePage() {
    const features = [
        {
            ...
            description: "Intimate knowledge of Knightsbridge's luxury boutiques, hotels, and private residences."
        },
        {
            icon: <Clock className="w-6 h-6 text-gold-400" />,
            title: "Punctuality",
            description: "Always on time, waiting for you at Harrods, Harvey Nichols, or your residence."
        },
        {
            icon: <Shield className="w-6 h-6 text-gold-400" />,
            title: "Discretion",
            description: "Professional chauffeurs who understand the importance of privacy for high-profile clients."
        },
        {
            icon: <Star className="w-6 h-6 text-gold-400" />,
            title: "Luxury Fleet",
            description: "Immaculate Mercedes-Benz and Range Rover vehicles for the ultimate arrival."
        }
    ];
    ...
    const jsonLd = {
        ...
        "@type": "Service",
        "serviceType": "Chauffeur Service Knightsbridge",
        "provider": {
            "@type": "LocalBusiness",
    ...
    return (
        <>
                ...
                <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-white/60 font-manrope font-light max-w-2xl leading-relaxed border-l border-white/10 pl-8">
                            The definitive luxury car service for London's most prestigious shopping district. Serving Harrods, The Berkeley, The Mandarin Oriental, and private residences in SW1.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-12">
                            <div>
                                <h2 className="text-4xl md:text-5xl font-italiana text-white mb-8">
                                    At Home in <span className="text-gold-400">Knightsbridge.</span>
                                </h2>

                                <div className="space-y-6 text-white/70 font-manrope font-light text-lg leading-relaxed">
                                    <p>
                                        Knightsbridge demands a level of service that goes beyond the ordinary. Our chauffeurs are well-versed in the etiquette and expectations of SW1's residents and visitors.
                                    </p>
                                    <p>
                                        Whether you require a shopping trip to Sloane Street, a dinner transfer to Zuma, or an airport transfer from your hotel, we provide a seamless, stress-free experience.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="relative h-[600px] border border-white/10 p-2">
                            <div className="relative h-full w-full overflow-hidden bg-zinc-900">
                                <Image
                                    src="/business.png"
                                    alt="Chauffeur Service Knightsbridge"
                                    fill
            ...
            <BookingSection />
            <StickyCTA label="Get a Knightsbridge Quote" />
        </>
    );
}
