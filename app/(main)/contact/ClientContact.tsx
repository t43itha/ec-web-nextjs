    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-white font-cinzel mb-6">Contact Information</h2>
              ...
              <div className="space-y-6">
                <a href="tel:+447340801274" className="flex items-start space-x-4 group">
                ...
                <a href="mailto:bookings@eugenechauffeurs.com" className="flex items-start space-x-4 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-lg flex items-center justify-center group-hover:from-gold-500/20 group-hover:to-gold-600/20 transition-all duration-300">
              ...
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gold-500/20">
                <h3 className="text-xl font-bold text-white font-cinzel mb-4">Quick Actions</h3>
                <div className="space-y-3">
                  <button onClick={handleWhatsAppContact} className="w-full flex items-center justify-between bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors group">
                  ...
                  <a href="tel:+447340801274" className="w-full flex items-center justify-between bg-zinc-800 text-white px-6 py-3 rounded-lg hover:bg-zinc-700 transition-colors group border border-gold-500/20">
                    <div className="flex items-center space-x-3">
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gold-500/20">
              <h2 className="text-3xl font-bold text-white font-cinzel mb-6">Send Us a Message</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitStatus === 'success' && (
                  <div className="flex items-center space-x-3 bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                    ...
                    <p className="text-green-500 font-montserrat">Thank you! Your message has been sent successfully. We'll respond within 24 hours.</p>
                  </div>
                )}
                {submitStatus === 'error' && (
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                    <p className="text-red-500 font-montserrat">We're sorry, there was an error sending your message. Please try again or contact us directly.</p>
                  </div>
                )}
                <button type="submit" disabled={isSubmitting} className="w-full flex items-center justify-center space-x-3 bg-gradient-to-r from-gold-400 to-gold-600 text-black px-8 py-4 rounded-lg font-montserrat font-bold text-lg hover:from-gold-500 hover:to-gold-600 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none">
                  {isSubmitting ? (
                    <>
      ...
      <section className="py-20 bg-gradient-to-br from-zinc-900 to-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white font-cinzel mb-4">Need <span className="text-gradient-gold">Help?</span></h2>
          <p className="text-xl text-white/80 font-montserrat mb-8">Check our frequently asked questions or contact us directly</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/#faq" className="inline-flex items-center justify-center bg-zinc-800 text-white px-6 py-3 rounded-lg font-montserrat font-semibold hover:bg-zinc-700 transition-colors border border-gold-500/20">View FAQ</Link>
            <a href="https://wa.me/447340801274" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center bg-green-600 text-white px-6 py-3 rounded-lg font-montserrat font-semibold hover:bg-green-700 transition-colors">
