...
export const metadata: Metadata = {
  title: 'London City Airport Chauffeur Service | Luxury Airport Transfers London',
  description: 'Premium chauffeur service to and from London City Airport. Real-time flight monitoring, meet & greet, and luxury vehicles for a seamless journey.',
};
...
const LCYPage = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Specialized service for the Private Jet Centre at London City Airport, ensuring discreet and direct access."
    }
  ];
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-white/60 font-manrope font-light max-w-2xl leading-relaxed border-l border-white/10 pl-8">
              The ultimate in airport luxury. Seamless connections between Central London and London City Airport.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4">
              ...
              <p className="text-white/60 font-manrope font-light">
                Every London City Airport transfer includes our signature premium amenities as standard.
              </p>
            </div>
