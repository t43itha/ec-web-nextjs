...
export const metadata: Metadata = {
  title: 'Stansted Chauffeur Service | Luxury Airport Transfers London',
  description: 'Premium chauffeur service to and from Stansted Airport. Real-time flight monitoring, meet & greet, and luxury vehicles for a seamless journey.',
};
...
const StanstedPage = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Expert service for Stansted's private jet terminals, including Harrods Aviation and Universal Aviation."
    }
  ];
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-white/60 font-manrope font-light max-w-2xl leading-relaxed border-l border-white/10 pl-8">
              The ultimate in airport luxury. Seamless connections between London and Stansted Airport, specializing in private aviation transfers.
            </p>
          </div>
        </div>
      </section>
