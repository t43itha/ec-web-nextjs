                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                      ...
                      <span className="text-gold-400 font-italiana text-lg">£{AIRPORT_FARES.heathrow.e_class}</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                      <span className="text-white/70 font-manrope text-sm">Gatwick</span>
                      <span className="text-gold-400 font-italiana text-lg">£{AIRPORT_FARES.gatwick.e_class}</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                      <span className="text-white/70 font-manrope text-sm">City</span>
                      <span className="text-gold-400 font-italiana text-lg">£{AIRPORT_FARES.lcy.e_class}</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                      <span className="text-white/70 font-manrope text-sm">Stansted</span>
                      <span className="text-gold-400 font-italiana text-lg">£{AIRPORT_FARES.stansted.e_class}</span>
                    </div>
                  </div>
                </div>
              </div>
