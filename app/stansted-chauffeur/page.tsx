...
export const metadata: Metadata = {
  title: 'Stansted Chauffeur Service — Meet & Greet, Flight Tracking',
...
export default function StanstedPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Intimate knowledge of Stansted Airport for the most efficient drop-offs and pickups."
    }
  ];

  const faqs = [
    {
      q: "Where will my chauffeur meet me at Stansted?",
  ...
  const jsonLd = {
    ...
    "@type": "Service",
    "serviceType": "Stansted Chauffeur Service",
    "provider": {
      "@type": "LocalBusiness",
      ...
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "Stansted Airport",
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-white/60 font-manrope font-light max-w-2xl leading-relaxed border-l border-white/10 pl-8">
              Executive Stansted transfers with meet & greet, flight tracking, and luxury vehicles for a seamless journey.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-12">
              <div>
                ...
                <div className="space-y-6 text-white/70 font-manrope font-light text-lg leading-relaxed">
                  <p>
                    Navigating Stansted requires precision. Our service transforms the chaos of international travel into a moment of calm. From the moment you land, our team is tracking your progress.
                  </p>
                  <p>
            ...
            <div className="relative h-[600px] border border-white/10 p-2">
              <div className="relative h-full w-full overflow-hidden bg-zinc-900">
                <Image
                  src="/airport svc.png"
                  alt="Luxury Stansted Chauffeur Service"
                  fill
        ...
        <div className="max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-black/50 p-6 border border-white/10">
              ...
              <p className="text-white/60 font-manrope text-sm">Your chauffeur will meet you directly at the FBO reception.</p>
            </div>
          </div>
        </div>
      </section>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="py-4 px-4 text-white/60 font-manrope text-right">£{AIRPORT_FARES.stansted.s_class}</td>
                    </tr>
                    <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                      <td className="py-4 px-4 text-white font-manrope">Mercedes-Benz V-Class</td>
                      <td className="py-4 px-4 text-white/60 font-manrope text-right">£{AIRPORT_FARES.stansted.v_class}</td>
                    </tr>
                    <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                      <td className="py-4 px-4 text-white font-manrope">Range Rover</td>
                      <td className="py-4 px-4 text-white/60 font-manrope text-right">£{AIRPORT_FARES.stansted.range_rover}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4">
              ...
              <p className="text-white/60 font-manrope font-light">
                Every Stansted transfer includes our signature premium amenities as standard.
              </p>
            </div>
