...
export default function LutonPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Intimate knowledge of Luton Airport for the most efficient drop-offs and pickups."
    }
  ];
  ...
  const jsonLd = {
    ...
    "@type": "Service",
    "serviceType": "Luton Chauffeur Service",
    "provider": {
      "@type": "LocalBusiness",
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-white/60 font-manrope font-light max-w-2xl leading-relaxed border-l border-white/10 pl-8">
              Executive Luton transfers with meet & greet, flight tracking, and luxury vehicles for a seamless journey.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-black/50 p-6 border border-white/10">
              ...
              <p className="text-white/60 font-manrope text-sm">Your chauffeur will meet you directly at the FBO reception or tarmac side (if permitted).</p>
            </div>
          </div>
        </div>
      </section>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="py-4 px-4 text-white/60 font-manrope text-right">£{AIRPORT_FARES.luton.s_class}</td>
                    </tr>
                    <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                      <td className="py-4 px-4 text-white font-manrope">Mercedes-Benz V-Class</td>
                      <td className="py-4 px-4 text-white/60 font-manrope text-right">£{AIRPORT_FARES.luton.v_class}</td>
                    </tr>
                    <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                      <td className="py-4 px-4 text-white font-manrope">Range Rover</td>
                      <td className="py-4 px-4 text-white/60 font-manrope text-right">£{AIRPORT_FARES.luton.range_rover}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
