...
export const events: Record<string, EventData> = {
  'royal-ascot': {
    ...
    dates: 'June (5 days)',
    metaTitle: 'Royal Ascot Chauffeur | Race Day Transport',
  ...
  'wimbledon': {
    ...
    metaTitle: 'Wimbledon Chauffeur | Championships Transport',
  ...
  'cheltenham': {
    ...
    dates: 'March (4 days)',
    metaTitle: 'Cheltenham Festival Chauffeur | Race Day Transport',
  ...
  'henley': {
    ...
    metaTitle: 'Henley Regatta Chauffeur | Event Transport',
  ...
  'goodwood': {
    ...
    metaTitle: 'Goodwood Chauffeur | Festival of Speed & Revival Transport',
  ...
  'chelsea-flower-show': {
    ...
    dates: 'May (5 days)',
    metaTitle: 'Chelsea Flower Show Chauffeur | Event Transport',
  ...
  'farnborough-airshow': {
    ...
    metaTitle: 'Farnborough Airshow Chauffeur | Event Transport',
  ...
  'bafta': {
    ...
    dates: 'February',
    metaTitle: 'BAFTA Chauffeur | Awards Night Transport',
