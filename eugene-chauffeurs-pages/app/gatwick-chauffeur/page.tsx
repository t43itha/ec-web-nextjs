...
export default function Page() {
  return (
    <main style={ padding: "32px 16px 96px", maxWidth: 900, margin: "0 auto", lineHeight: 1.6 }>
      <h1 style={ fontSize: 32, marginBottom: 12 }>Gatwick Chauffeur & Airport Transfers</h1>
      
<section>
  <h2>Gatwick Chauffeur & Airport Transfers</h2>
...
<section>
  <h3>What’s included at Gatwick</h3>
  <ul>
...
<section>
  <h3>Gatwick ↔ Central London — from</h3>
  <table style="width:100%;border-collapse:collapse">
    ...
    <tbody>
      <tr><td style="padding:8px;border-bottom:1px solid #f0f0f0">Mercedes-Benz S-Class</td><td style="padding:8px;text-align:right;border-bottom:1px solid #f0f0f0">£250</td></tr>
      <tr><td style="padding:8px;border-bottom:1px solid #f0f0f0">Mercedes-Benz V-Class</td><td style="padding:8px;text-align:right;border-bottom:1px solid #f0f0f0">£250</td></tr>
      <tr><td style="padding:8px;border-bottom:1px solid #f0f0f0">Range Rover</td><td style="padding:8px;text-align:right;border-bottom:1px solid #f0f0f0">£290</td></tr>
    </tbody>
  </table>
...
<section id="quote">
  ...
  <p>WhatsApp or call us on <strong>+44 7340 801 274</strong>, or send your itinerary via the quote form.</p>
      ...
      <section id="faq" style={ marginTop: 32 }>
        <h2>FAQs</h2>
        <p><strong>Where will my chauffeur meet me at Gatwick?</strong><br/>In the arrivals hall after customs, holding a nameboard.</p>
...
<p><strong>Can you add extra stops?</strong><br/>Yes—include the stop in your request; extra time/distance may apply.</p>
      ...
      <LDJson json={"@context": "https://schema.org", "@type": "Service", "serviceType": "Gatwick Chauffeur Service", "provider": {"@type": "LocalBusiness", "name": "Eugene Chauffeurs", "url": "https://ec-web-nextjs.netlify.app/", "telephone": "+44 7340 801 274", "address": {"@type": "PostalAddress", "streetAddress": "[Street]", "addressLocality": "London", "postalCode": "[Postcode]", "addressCountry": "GB"}, "hasCredential": "TfL Operator Licence: 0108860101"}, "areaServed": "Gatwick", "termsOfService": "Free waiting time: 60 minutes arrivals / 15 minutes departures & non-airport pick-ups.", "offers": {"@type": "AggregateOffer", "priceCurrency": "GBP", "lowPrice": "165", "highPrice": "300", "availability": "https://schema.org/InStock"}} />
