...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/book', destination: '/contact#contact-section', permanent: true },
      { source: '/book/', destination: '/contact#contact-section', permanent: true },
      { source: '/booking', destination: '/contact#contact-section', permanent: true },
      { source: '/booking/', destination: '/contact#contact-section', permanent: true },
      ...
      { source: '/business-london/', destination: '/landing/business/london', permanent: true },
      { source: '/event-birmingham', destination: '/landing/event/birmingham', permanent: true },
      { source: '/event-birmingham/', destination: '/landing/event/birmingham', permanent: true },
      { source: '/v-class-chauffeur-hire', destination: '/mercedes-v-class-chauffeur', permanent: true },
      { source: '/v-class-chauffeur-hire/', destination: '/mercedes-v-class-chauffeur', permanent: true },
